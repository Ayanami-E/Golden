...
def main():
    ...
    print("------ Training NPNet-V (Proposal Ver) ------")
    ...
    plt.subplot(1, 3, 1); plt.plot(all_steps, losses); plt.title("Total Loss")
    plt.subplot(1, 3, 2); plt.plot(all_steps, main_losses); plt.title("Main Loss")
    plt.subplot(1, 3, 3); plt.plot(all_steps, temp_losses); plt.title("Temp Loss")
    plt.tight_layout()
    plt.savefig("loss_curve.png")

    torch.save(npnet.state_dict(), "npnet_v_final.pth")
    print("Saved npnet_v_final.pth")
